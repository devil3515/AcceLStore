...
import { ArrowDownToLine, CheckCircle, Leaf, Shield, Zap } from "lucide-react";
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          ...
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            AcceLStore welcomes you. Our team verifies each asset on the
            platform to guarantee that it meets our strict quality standards.{" "}
          </p>
