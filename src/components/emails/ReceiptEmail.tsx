...
export const ReceiptEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Your AcceLStore Receipt</Preview>
      ...
      <Body style={main}>
        <Container style={container}>
          <Section>
            <Column>
              <Img
                src={`${process.env.NEXT_PUBLIC_SERVER_URL}/ProLogo.png`}
                width="100"
                height="100"
                alt="AcceLStore"
              />
          ...
          <Text style={footerCopyright}>
            Copyright © 2024 AcceLStore.
            <br />{" "}
            <Link href="https://sandaldeep.vercel.app/">
              All rights reserved
            </Link>
          </Text>
        </Container>
